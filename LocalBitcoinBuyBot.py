...
class LocalBitcoinBuyBot():
    ...
    def valueAcceptable(self, value):
        return value >= self.lowest_value + self.lower_value and value <= self.highest_value + self.lower_value
    ...
    def getOnlineLowestSellPriceInUSD(self):
        ...
        for ad in onlineBuyAds['ad_list']:
            ...
            if (float(cur_value) < lowest_value):
                ...
                lowest_name = ad['data']['profile']['name']
        print('lowest ads ==> ', lowest_name, lowest_value)
        return {'value': lowest_value, 'name': lowest_name}
    ...
    def updateMyAdsPriceEquation(self, lowest_name,  price_in_usd):
        ...
        for ad in my_ads['ad_list']:
            ...
            if (ad['data']['profile']['name'] != lowest_name
                    and ad['data']['trade_type'] == 'ONLINE_SELL'
                ...
                if (price_in_usd < cur_price_in_usd):       # only update when the new price is lower than my ads sell price
                    ...
                    print('update ad ', ad_id, ' equation ', equation, ' value ', price_in_usd)
    ...
    def stop_thread(self):
        ...
        try:
            ...
            print('observer thread stop failed')
            pass
        del self.lcAgent